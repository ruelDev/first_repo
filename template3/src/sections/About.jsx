...
const About = (props) => {
  ...
  return (
      <section
          id='about'
          className={"relative overflow-hidden z-10 flex justify-center items-center min-h-[700px] py-10 shadow-[0px_10px_10px_10px_#000000]"}
          style={{
      ...
      >
        <motion.div
            ...
            className="container mx-auto flex flex-col items-center justify-between py-10"
        >
          <motion.div
              variants={{
                offscreen: {
